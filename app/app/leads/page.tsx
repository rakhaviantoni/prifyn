...
export default async function LeadsPage() {
  ...
  return <div className="app-content leads-page"><header className="app-page-head"><div><span>CRM Lite</span><h1>Lead Inbox</h1><p>Book appointment and Apply online submissions land here for the active PRIFYN brand workspace.</p></div><span className="status-pill"><CheckCircle weight="fill" /> {leads.length} lead{leads.length === 1 ? "" : "s"}</span></header>
