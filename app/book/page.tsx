...
export default function BookPage() {
  return <div className="marketing-page"><div className="subpage-header"><MarketingHeader /></div><main>
    ...
    <section className="section section-paper intake-section" id="book-form"><div className="marketing-container intake-content-grid"><div><span className="section-kicker">Appointment request</span><h2>Use this if your flow is still messy.</h2><p>Best for teams that want PRIFYN to translate briefs, campaigns, channels, creators, and reports into one clear operating flow.</p><div className="intake-mini-list"><span><FileArrowUp /> Existing reports are enough to start</span><span><UsersThree /> Works for brand, agency, and KOL teams</span><span><CheckCircle /> We focus on the first useful decision</span></div></div><PublicIntakeForm type="appointment" /></div></section>
