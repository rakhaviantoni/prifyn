...
const translations: Record<string, string> = {
  ...
  "Billing & Usage": "Billing & Penggunaan",
  ...
  "Sign in to PRIFYN": "Masuk ke PRIFYN",
  "Sign in as creator": "Masuk sebagai kreator",
  "PRIFYN admin sign in": "Masuk admin PRIFYN",
  "Continue to your brand workspace.": "Lanjut ke workspace brand Anda.",
  "Continue to your creator dashboard.": "Lanjut ke dashboard kreator Anda.",
  "Continue to the internal business manager.": "Lanjut ke business manager internal.",
  "Need access? Ask a PRIFYN owner to approve your account.": "Butuh akses? Minta owner PRIFYN menyetujui akun Anda.",
  "Creator": "Kreator",
  "Workspace": "Workspace",
  "Admin": "Admin",
  "Create your workspace": "Buat workspace Anda",
  "Create creator account": "Buat akun kreator",
  "Set up your company workspace and start from one real campaign.": "Siapkan workspace perusahaan dan mulai dari satu campaign nyata.",
  "Build a profile brands can trust and apply to matched campaigns.": "Bangun profil yang dipercaya brand dan apply ke campaign yang sesuai.",
  "Continue with Google": "Lanjutkan dengan Google",
  "or continue with email": "atau lanjutkan dengan email",
  "Work email": "Email kerja",
  "Password": "Kata sandi",
  "Create account": "Buat akun",
  "Creator display name": "Nama publik kreator",
  "Agency / workspace name": "Nama agensi / workspace",
  "Company / workspace name": "Nama perusahaan / workspace",
