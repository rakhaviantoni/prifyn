...
type AppointmentSlot = { id: string; label: string; startTime: string; endTime: string; timezone: string; note: string; status: string; sortOrder: number };
